...
const THEMES = [
  ...
  },
  {
    ...
    tokens: {
      ...
      'color-accent-1': '#6BD8C4',
      'color-accent-2': '#F2B854',
      'color-accent-3': '#E2664A',
    },
  },
  {
    name: 'Ember',
...
const header = {
  ...
  totalDebtAmount:          `truncate font-bold text-sm/[1.25rem] text-[${COLORS['color-accent-2']}]`,
...
logoIconStyle:     { height: '42px', width: 'auto', aspectRatio: '91 / 24' },
  ...
  pillCenterText:     `flex-1 text-center font-medium text-base text-[${COLORS['color-text-prim']}]`,
  ...
  rollerItem:        `h-6 leading-6 font-medium text-base text-[${COLORS['color-accent-1']}] whitespace-nowrap text-left`,
};
...
const residentCard = {
  ...
  residentName:            `font-medium tracking-wide truncate text-lg text-[${COLORS['color-text-prim']}]`,
  apartmentNumber:         `font-medium truncate text-sm text-[${COLORS['color-text-dim']}]`,
  totalDebtText:           `font-bold text-[22px]/[22px] text-[${COLORS['color-accent-2']}]`,
  totalDebtCurrencyMod:    "text-[0.7em]/[22px] mr-0.5 font-bold",
  noDebtText:              `font-light text-[16px] text-[${COLORS['color-accent-1']}]`,
  ...
  addExpenseBtn:           `w-[100px] h-[44px] rounded-[22px] bg-[${COLORS['color-cardback-dim']}] font-bold text-sm text-[${COLORS['color-text-prim']}] flex items-center justify-center outline-none shrink-0 transition-transform active:scale-95`,
  ...
  expenseValueAmount:      (isPaid) => `font-medium shrink-0 text-lg pointer-events-none ${isPaid ? `text-[${COLORS['color-text-dim']}]` : `text-[${COLORS['color-text-prim']}]`}`,
...
const historyDrawer = {
  ...
  pastMonthLabel:             `font-medium truncate text-[12px] text-[${COLORS['color-text-dim']}]`,
  ...
  toggleBarAmount:            `font-bold shrink-0 text-base text-[${COLORS['color-text-prim']}]/70`,
...
const modal = {
  ...
  deleteYesBtn:               `flex-1 font-bold transition-transform active:scale-95 h-12 rounded-[9999px] text-[${COLORS['color-text-prim']}]`,
  deleteYesBtnStyle:          { backgroundColor: COLORS['color-accent-3'] },
  deleteNoBtn:                `flex-1 font-bold transition-transform active:scale-95 h-12 rounded-[9999px] bg-[${COLORS['color-cardback-dim']}] text-[${COLORS['color-text-prim']}]`,
...
const cardModal = {
  ...
  nameFieldInput:       `font-bold text-[18px] text-[${COLORS['color-text-prim']}]`,
  ...
  notesTitle:           `text-sm font-medium text-[${COLORS['color-text-dim']}]`,
...
const buildingExpenses = {
  ...
  itemDescription:      (isPaid) => `font-medium truncate pr-2 text-base ${isPaid ? `text-[${COLORS['color-text-dim']}] line-through decoration-[${COLORS['color-accent-1']}] decoration-1` : `text-[${COLORS['color-text-prim']}]`}`,
  itemAmount:           (isPaid) => `font-medium shrink-0 text-lg pointer-events-none ${isPaid ? `text-[${COLORS['color-text-dim']}]` : `text-[${COLORS['color-text-prim']}]`}`,
  ...
  prevMonthSubLabel:    `font-medium truncate text-[12px] text-[${COLORS['color-text-dim']}]`,
