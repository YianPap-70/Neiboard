...
const THEMES = [
  {
    ...
    tokens: {
      ...
      'color-textback': '#303a48',
      'color-cardback-dim': '#374151',
      'color-cardback-prim': '#1f2937',
      'color-button1': '#465670',
      'color-button2': '#075985',
...
const navigationPill = {
  ...
  padding: '0 8px',
  borderRadius: '9999px',
  backgroundColor: COLORS['color-cardback-prim'],
  border: 'none',
  height: '52px',
  width: 'auto',
  display: 'flex',
...
const modal = {
  expenseModal: {
    ...
    amountWrapper:            `h-[52px] px-4 rounded-[6px] bg-[${COLORS['color-textback']}] w-full flex items-center`,
    ...
    descriptionWrapper:       `h-[52px] px-4 rounded-[6px] bg-[${COLORS['color-textback']}] w-full flex items-center`,
    descriptionInput:         `bg-transparent w-full focus:outline-none text-[16px] font-normal text-[${COLORS['color-text-prim']}]`,

recurringPill: `w-full h-[52px] rounded-[9999px] flex items-center justify-center gap-2 transition-all duration-300 outline-none select-none cursor-pointer`,
    recurringPillRingActive: `bg-[${COLORS['color-button2']}]`,
    recurringPillRingInactive: `bg-[${COLORS['color-button1']}]`,
    recurringPillText:        `text-[16px] font-normal text-[${COLORS['color-text-prim']}]`,

    statusPill: `w-full h-[52px] rounded-[9999px] flex items-center justify-center gap-2 transition-all duration-300 outline-none select-none cursor-pointer`,
    statusPillRingUnpaid: `bg-[${COLORS['color-warn2']}]`,
    statusPillRingPaid: `bg-[${COLORS['color-button1']}]`,
    ...
    deleteBtn:                `w-[52px] h-[52px] shrink-0 rounded-[9999px] bg-[${COLORS['color-warn2']}] flex items-center justify-center transition-transform active:scale-95 outline-none select-none cursor-pointer`,
    deleteIcon:               `w-6 h-6 text-[${COLORS['color-text-prim']}]`,
    paidIconClass:            `${icons.statusIconSize} text-[${COLORS['color-ok']}]`,
    unpaidIconClass:          `${icons.statusIconSize} text-[${COLORS['color-text-prim']}]`,
    statusPillGap:            "gap-2",
  },
  ...
  calendar: {
    ...
    monthButtonSelectedBg:    COLORS['color-button1'],
...
const cardModal = {
  ...
  fieldWrapper:         `bg-[${COLORS['color-textback']}] rounded-[6px] w-full`,
  ...
  notesFieldWrapper:    `bg-[${COLORS['color-textback']}] rounded-[6px] w-full`,
  ...
  trashBtn:             `w-[44px] h-[44px] shrink-0 rounded-[9999px] bg-[${COLORS['color-warn2']}] flex items-center justify-center transition-transform active:scale-95 outline-none select-none`,
  ...
  deleteConfirmYesBtn:  `flex-1 h-[44px] rounded-[9999px] bg-[${COLORS['color-warn2']}] font-normal text-[${COLORS['color-text-prim']}] flex items-center justify-center transition-transform active:scale-95 outline-none select-none`,
